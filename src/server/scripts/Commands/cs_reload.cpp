...
public:
    ...
    static bool HandleReloadAllCommand(ChatHandler* handler, const char* /*args*/)
    {
        ...
        HandleReloadCoreStringCommand(handler,"");
    ...
    static bool HandleReloadCoreStringCommand(ChatHandler* handler, const char* /*args*/)
    {
        sLog->outString("Re-Loading core_string Table!");
        sObjectMgr->LoadCoreStrings();
        handler->SendGlobalGMSysMessage("DB table `core_string` reloaded.");
        return true;
    }
