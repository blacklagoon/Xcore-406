...
# define _TRINITY_REALM_CONFIG  "./configs/authserver.conf"
#endif //_TRINITY_REALM_CONFIG

#ifdef _WIN32
#include "ServiceWin32.h"
char serviceName[] = "authserver";
char serviceLongName[] = "UltraCore G5 Auth service";
char serviceDescription[] = "UltraCore G5 World of Warcraft emulator world auth service";
/*
...
extern int main(int argc, char **argv)
{
    ...
    sLog->outString("%s (G5 Authentication-Daemon)", _FULLVERSION);
	    sLog->outString(" ");
	 sLog->outString(" ");
	sLog->outString("                 *******     *******    *******    *******  ");
	sLog->outString("               /** ////**  /** ////**  /**////**  /**////** ");
	...
	sLog->outString("                 //////      //////    ///////    ///////        ");
	sLog->outString( "       ");
	sLog->outString("               The Catacrunch Database Development Project");

	sLog->outString("       Based on the Skyfire original 406 core and the Ultracore G5 core       ");
	sLog->outString( "       ");
    sLog->outString("                                              http://www.ccdb-home.org");
    sLog->outString("                    CCDB 2012(c) Open-sourced Game Emulation ");
    ...
    {
        sLog->outError("G5-Auth can not bind to %s:%d", bind_ip.c_str(), rmport);
        return 1;
    }
...
#ifdef _WIN32
    {
        ...
        if (Prio)
        {
            if (SetPriorityClass(hProcess, HIGH_PRIORITY_CLASS))
                sLog->outString("G5-Auth process priority class set to HIGH");
            else
